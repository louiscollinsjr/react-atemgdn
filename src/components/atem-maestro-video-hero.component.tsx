    ...
    return (
      <section className="relative flex flex-col justify-center items-center w-full my-32">
        <div className="flex flex-row z-30 w-full max-w-[27.43rem] md:max-w-screen-2xl pb-12 bg-red-">
          <div className="grid grid-cols-1 md:grid-cols-2 items-center bg-red w-full gap-0">
            <div className="~text-xl/9xl items-center">
              <h1 className="font-non.geist ~text-[4rem]/[6rem] font-medium tracking-tighter text-black md:items-center">
                atem
              </h1>
            </div>
            <div className="flex ~text-xl/9xl items-center bg-green md:content-end md:justify-end">
              <div className=' bg-slate '>
                <p className=" text-black ~text-xl/3xl font-medium tracking-wide  md:items-center">
                  Maestro,
                  <br />
        ...
        <div
          className={`relative flex justify-center items-center w-full  min-h-[60rem]  max-w-[27.47rem] md:max-w-[120rem]`}
        >
        
          <video
            ref={videoRef}
            className={`transition-all duration-500 absolute justify-center h-full max-w-[27.47rem] md:max-w-[120rem]  items-center object-cover bg-green-500 
            `}
            style={
              {
