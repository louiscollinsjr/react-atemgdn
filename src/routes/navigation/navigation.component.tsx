...
const Navigation: React.FC = () => {
      ...
      <nav className="md:h-auto bg-black md:bg-white fixed w-full z-50 backdrop-filter backdrop-blur-lg md:bg-opacity-30">
        <div className="max-w-screen-2xl mx-auto px-4 md:px-4  py-3 flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-4">
            ...
            <NavLink className="text-xs nav-link" to="/design">
            Design and Development
            </NavLink>
            <NavLink className="text-xs nav-link" to="/satchel">
            Satchel AR
            </NavLink>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 9h16.5m-16.5 6.75h16.5" />
        ...
        <div className="hidden md:flex justify-between max-w-screen-2xl mx-auto md:px-4 py-3 ">
          ...
          <div className="space-x-4">
            ...
            <NavLink className="text-xs nav-link" to="#contact-section">
            Contact us
            </NavLink>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M6 18 18 6M6 6l12 12" />
          ...
          <div className="px-4 pb-4 pt-6 space-y-2">
            ...
            {/* <a className="block text-white  hover:text-gray-300 text-3xl py-2" href="#" onClick={() => setIsMobileNavOpen(false)}>Design and Development</a>
            <a className="block text-white hover:text-gray-300 text-3xl py-2" href="#" onClick={() => setIsMobileNavOpen(false)}>Satchel AR</a>
            <a className="block text-white hover:text-gray-300 text-3xl py-2" href="#" onClick={() => setIsMobileNavOpen(false)}>atem.Labs</a>
            
    
              <a className="block text-white hover:text-gray-300 text-3xl py-2" href="#" onClick={() => setIsMobileNavOpen(false)}>Overview</a>
              <a className="block text-white hover:text-gray-300 text-3xl py-2" href="#contact-section" onClick={() => setIsMobileNavOpen(false)}>Contact us</a>
               */}
